  ...
  for (let i = 0; i < array.length - 1; i++) {
    ...
    for (let j = i; j < array.length - 1; j++) {
      ...
      for (let k = j; k < array.length - 1; k++) {
        ...
        if (sum === 2020) {
          console.log(`${array[i]}, ${array[j + 1]}, ${array[k + 1]}`)
...
console.log(sumOfTriplets(lines))
//solution:
//_> 483, 565, 972
//_> 265253940
// console.log(sumOfTriplets(testArray))